...
export const TRANSLATIONS: Record<'fr' | 'ar', TranslationDict> = {
  fr: {
    ...
    heroPhotoBadgeFr: "Mouvement Social & Politique à Kiffa",
    ...
    popSectionTitleFr: "Popularité du Mouvement à Kiffa & Impact Citoyen",
    popLocationFr: "Kiffa, Assaba, Mauritanie",
    popCard1Val: "",
    popCard1LabelFr: "Citoyens de Kiffa Engagés",
    popCard2Val: "",
    popCard2LabelFr: "Visites Citoyennes Aujourd'hui",
    popCard3Val: "",
    popCard3LabelFr: "Vues Totales du Mouvement",
    ...
    mapBadge: "Carte des Interventions & Ancrage Territorial",
    mapTitle: "Zones d'Influence & Actions à Kiffa et Nouakchott et Nema",
    mapSubtitle: "Explorez les points d'adduction d'eau, forages solaires, bureaux de coordination à Nouakchott, caravanes médicales et permanences citoyennes du mouvement Amel Hassi El Bkay.",
    ...
    cardRectoHeaderAr: "أمل حاسي البكاي",
    cardRectoHeaderFr: "AMEL HASSI EL BEKAY",
    cardRectoBadgeAr: "بطاقة عضوية",
    cardRectoBadgeFr: "CARTE ADHÉRENT",
    cardRectoSubtitleAr: "المبادرة الاجتماعية والسياسية بكيفه",
    cardRectoSubtitleFr: "Mouvement Social & Politique à Kiffa",
    cardRectoFooterAr: "حراك مدني وطني للتنمية والعدالة",
    cardRectoFooterFr: "Mouvement Citoyen pour le Développement et l'Eau",
    cardVersoHeaderFr: "Charte de l'Adhérent",
    cardVersoHeaderAr: "مبادئ ميثاق الانتساب للحراك",
    cardVersoStamp: "AMEL APPROUVÉ",
    cardVersoSignatureFr: "Signature du Président",
    cardVersoSignatureAr: "توقيع الرئيس",
    cardRule1TitleFr: "1. Sceau d'Eau / Développement:",
    cardRule1DescFr: "Engagement pour l'eau potable pour chaque citoyen.",
    cardRule1TitleAr: "1. السقاية والتنمية:",
    cardRule1DescAr: "التعهد بالسقاية وتوفير مياه الشرب للساكنة.",
    cardRule2TitleFr: "2. Jeunesse / Civisme:",
    cardRule2DescFr: "Autonomisation et moustachage des cadres de demain.",
    cardRule2TitleAr: "2. الشباب والمواطنة:",
    cardRule2DescAr: "مرافقة الشباب وتمكينهم وتأهيلهم محلياً.",
    cardRule3TitleFr: "3. Intégrité / Transparence:",
    cardRule3DescFr: "Respect absolu de la transparence budgétaire.",
    cardRule3TitleAr: "3. النزاهة والشفافية:",
    cardRule3DescAr: "احترام النزاهة والشفافية المالية التامة.",
    cardRule4TitleFr: "",
    cardRule4DescFr: "",
    cardRule4TitleAr: "",
    cardRule4DescAr: "",
  ...
  ar: {
    ...
    heroPhotoBadgeAr: "حراك اجتماعي وسياسي بكيفه",
    ...
    popSectionTitleAr: "مؤشر الشعبية والتفاعل الشعبي لبلدية كيفه",
    popLocationAr: "كيفه، العصابة، موريتانيا",
    popCard1Val: "",
    popCard1LabelAr: "المواطنون الملتزمون بكيفه",
    popCard2Val: "",
    popCard2LabelAr: "زيارات الموقع اليوم",
    popCard3Val: "",
    popCard3LabelAr: "إجمالي التفاعل الشعبي",
    ...
    mapBadge: "خريطة التدخلات والتواجد الميداني",
    mapTitle: "مناطق النفوذ والأنشطة بكيفه ونواكشوط والنعمة",
    mapSubtitle: "استعرض خريطة الآبار، محطات توزيع المياه، مكاتب التنسيق بنواكشوط، والقوافل الطبية والمقرات الشعبية التابعة لحركة أمل حاسي البكاي بكيفه والنعمة.",
